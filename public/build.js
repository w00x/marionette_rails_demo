...
var _todo = require('../model/todo.js');
...
},{"../model/todo.js":4,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],2:[function(require,module,exports){
'use strict';
...
var _todo_view = require('../view/todo_view.js');

var _todo_view2 = _interopRequireDefault(_todo_view);

var _todos = require('../collection/todos.js');
...
var MainController = {
  index: function index(app) {
    var todos = new _todos2.default();
    todos.fetch();
    app.showView(new _todo_view2.default({ collection: todos }));
  }
};

exports.default = MainController;

},{"../collection/todos.js":1,"../view/todo_view.js":19,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],3:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)(document).ready(function () {
  var TodoApp = new _backbone4.default.Application({
    region: '#container',
    onStart: function onStart() {
      new _route2.default(this);
    }
  });
  TodoApp.start();
...
},{"./route.js":10,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],4:[function(require,module,exports){
'use strict';
...
},{"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],5:[function(require,module,exports){
...
var _main_controller = require('./controller/main_controller.js');
...
var RouteController = {
  main_controller_index: function main_controller_index() {
    _main_controller2.default.index(App);
  }
};

var TodoRouter = _backbone4.default.AppRouter.extend({
...
},{"./controller/main_controller.js":2,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],11:[function(require,module,exports){
'use strict';
...
var _empty_todos_template = require('./template/empty_todos_template.html');

var _empty_todos_template2 = _interopRequireDefault(_empty_todos_template);
...
var EmptyTodosList = _backbone4.default.View.extend({
  template: _underscore2.default.template(_empty_todos_template2.default)
});

exports.default = EmptyTodosList;

},{"./template/empty_todos_template.html":14,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],12:[function(require,module,exports){
'use strict';
...
var _form_template = require('./template/form_template.html');

var _form_template2 = _interopRequireDefault(_form_template);
...
var FormView = _backbone4.default.View.extend({
  template: _underscore2.default.template(_form_template2.default),
  events: {
  ...
  createTodoTyped: function createTodoTyped(e) {
    if (e.which == 13) {
      this.createTodo();
    }
  }
...
},{"./template/form_template.html":15,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],13:[function(require,module,exports){
'use strict';
...
var _todo_item_view = require('./todo_item_view.js');

var _todo_item_view2 = _interopRequireDefault(_todo_item_view);

var _empty_todos_list = require('./empty_todos_list.js');

var _empty_todos_list2 = _interopRequireDefault(_empty_todos_list);
...
var ListTodos = _backbone4.default.CollectionView.extend({
  childView: _todo_item_view2.default,
  emptyView: _empty_todos_list2.default
});

exports.default = ListTodos;

},{"./empty_todos_list.js":11,"./todo_item_view.js":18,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],14:[function(require,module,exports){
module.exports = "<div class=\"\" style=\"margin-top: 5px;\">\n  <div class=\"alert alert-warning\" role=\"alert\">\n    Lista vacía\n  </div>\n</div>\n";

},{}],15:[function(require,module,exports){
module.exports = "<div id=\"form\" class=\"row\">\n  <div class=\"col-md-10\">\n    <input type=\"text\" class=\"form-control\" id=\"todo\" value=\"\">\n  </div>\n  <div class=\"col-md-2\">\n    <button type=\"button\" class=\"btn btn-primary\" id=\"send\">Guardar</button>\n  </div>\n</div>\n";

},{}],16:[function(require,module,exports){
module.exports = "<div id=\"todo_item\" class=\"row\">\n  <div class=\"col-md-1\">\n    <div class=\"checkbox\">\n        <label>\n          <input type=\"checkbox\" <%= doit ? 'checked' : '' %> id=\"doit\" value=\"\">\n        </label>\n      </div>\n  </div>\n  <div class=\"col-md-11\">\n    <span id=\"todo_desc\" class=\"<%= doit ? 'doit' : '' %>\"><%= todo %></span>\n  </div>\n</div>\n\n<style media=\"screen\">\n  .doit {\n    color: #D3D3D3;\n  }\n</style>\n";
...
var _todo_item_template = require('./template/todo_item_template.html');

var _todo_item_template2 = _interopRequireDefault(_todo_item_template);
...
var TodoItemView = _backbone4.default.View.extend({
  template: _underscore2.default.template(_todo_item_template2.default),
  ui: {
    todo_item: '#todo_item',
    doit: '#doit'
  },
...
},{"./template/todo_item_template.html":16,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}],19:[function(require,module,exports){
'use strict';
...
var _todo_template = require('./template/todo_template.html');

var _todo_template2 = _interopRequireDefault(_todo_template);

var _form_view = require('./form_view.js');

var _form_view2 = _interopRequireDefault(_form_view);

var _list_todos_collection_view = require('./list_todos_collection_view.js');

var _list_todos_collection_view2 = _interopRequireDefault(_list_todos_collection_view);
...
var TodoView = _backbone4.default.View.extend({
  template: _underscore2.default.template(_todo_template2.default),
  regions: {
    formTodo: '#formTodo',
    listTodo: '#listTodo'
  },
  onRender: function onRender() {
    this.showChildView('formTodo', new _form_view2.default({ collection: this.collection }));
    this.showChildView('listTodo', new _list_todos_collection_view2.default({ collection: this.collection }));
  }
});

exports.default = TodoView;

},{"./form_view.js":12,"./list_todos_collection_view.js":13,"./template/todo_template.html":17,"backbone":7,"backbone.marionette":5,"jquery":8,"underscore":9}]},{},[3]);
